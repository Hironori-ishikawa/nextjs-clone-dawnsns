...
const ResetPassword = () => {
  ...
  return (
    <div className="max-w-[400px] mx-auto">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="mb-5">
          {loading ? (
            ...
            <button
              type="submit"
              className="font-bold bg-sky-500 hover:brightness-95 w-full rounded-fill p-2 text-white text-sm"
            >
              送信
            </button>
          )}
      ...
      {/* メッセージ */}
      {message && <div className="my-5 text-ceb-center text-red-500">{message}</div>}
    </div>
  )
}
