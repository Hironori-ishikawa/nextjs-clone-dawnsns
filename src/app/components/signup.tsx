    ...
    <div className='max-w-[400] mx-auto'>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="mb-3">
          ...
          />
          <div className="my-3 text-center text-sm test-red-500">{errors.email?.message}</div>
        </div>
        ...
        <div className="mb-5">
          {loading ? (
            ...
            <button
              type='submit'
              className='font-bold bg-sky-500 hover:brigtness-95 w-full rounded-full p-2 text-white text-sm'>
              サインアップ
            </button>
          )}
        </div>
